...
<div class="cbqr-appearance-cols">
    <form id="cb-qr-code-appearance-form" method="post" action="#" autocomplete="off">
        ...
        <div class="qqc-form-row">
            ...
            <div class="qqc-input-unit-row">
                ...
                <span class="qqc-unit-indicator">units</span>
            </div>
        </div>
            ...
            <div class="qqc-color-cols">
                <div>
                    <label for="qr-code-dark"
                        class="qqc-color-label"><?php esc_html_e('Dark (hex)', 'cb-qr-code'); ?></label>
                ...
                <div>
                    <label for="qr-code-light"
                        class="qqc-color-label"><?php esc_html_e('Light (hex)', 'cb-qr-code'); ?></label>
        ...
        <div class="qqc-form-row">
            ...
            <div class="qqc-input-unit-row">
                ...
                <span class="qqc-unit-indicator">%</span>
            </div>
        </div>
        <div class="qqc-form-row">
    ...
    <div class="cbqr-appearance-preview">
        <h3><?php esc_html_e('Preview', 'cb-qr-code'); ?></h3>
        <div id="cb-qr-code-preview"></div>
    </div>
</div>